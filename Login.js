...
const Login = () => {
    ...
    const { fname, lname, pname, phone, email, pin, aadhar, state, address, account, bank, holdername, ifsc, errors } = useState(data)
    ...
    const handleSubmit=(e)=>{
        ...
        if(!fname&&!lname&&!pname&&!phone&&!email&&!aadhar&&!state&&!pin&&!address&&!account&&!bank&&!holdername&&!ifsc){
            alert('submit form')
        }
        else{
